...
/* Sleep Client DonutSMP payment command */
(function sleepPurchaseCommandComponent(){
  ...
  const strings={
    en:{
      eyebrow:'DONUTSMP PAYMENT',
      monthly:'Monthly Access',
      lifetime:'Lifetime Access',
      buyer:'Minecraft account',
      amount:'Amount',
      instruction:'Run this command in DonutSMP exactly as shown:',
      note:'Make sure you pay from the same Minecraft account shown here. After the payment is verified, your product key can be issued.',
      copy:'Copy Command',
      copied:'Copied!',
      close:'Close',
      missing:'Enter your Minecraft username first.'
    },
    de:{
      eyebrow:'DONUTSMP ZAHLUNG',
      monthly:'Monatszugang',
      lifetime:'Lifetime Zugang',
      buyer:'Minecraft Account',
      amount:'Betrag',
      instruction:'Führe diesen Befehl in DonutSMP genau so aus:',
      note:'Bezahle mit demselben Minecraft Account, der hier angezeigt wird. Nach der Prüfung der Zahlung kann dein Produktschlüssel erstellt werden.',
      copy:'Befehl kopieren',
      copied:'Kopiert!',
      close:'Schließen',
      missing:'Gib zuerst deinen Minecraft Namen ein.'
    }
  };
